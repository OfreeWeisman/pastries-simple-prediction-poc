...
def extract_features(row: dict[str, str], hide_ring_identity: bool = False) -> dict[str, float | str]:
    ...
    features: dict[str, float | str] = {
        "name": row["name"],
        "pas_total_rings": total_rings,
        "pas_total_annulations": total_annulations,
        "pas_total_l": total_l,
        "pas_total_a": total_a,
        "pas_l_fraction": total_l / total_annulations if total_annulations else 0.0,
        ...
        "pas_longest_l_run": longest_run(annulation_sequence, "L"),
        "pas_longest_a_run": longest_run(annulation_sequence, "A"),
        ...
        "paper_lalas_longest_lower_a": longest_run(raw_annulation_sequence, "a"),
        "paper_lalas_a_ratio": raw_annulation_upper.count("A") / len(raw_annulation_sequence)
        if raw_annulation_sequence
        else 0.0,
